...
# data
# -- bias
tidy.bias       <- read_rds(file = 'tidy_bias.rds') %>% ungroup()
# -- surveys
tidy.sam        <- read_rds(file = 'tidy_sam.rds')
tidy.iri        <- read_rds(file = 'tidy_iri.rds')
tidy.vivq       <- read_rds(file = 'tidy_vviq.rds')
# -- encoding success
tidy.enc        <- read_rds(file = 'tidy_enc.rds')
# -- dependency
tidy.dependency <- read_rds(file = 'tidy_dependency.rds')
# -- retrieval success
tidy.ret        <- read_rds(file = 'graded_df.rds')
